        ...
        private void metroButton3_Click(object sender, EventArgs e)
        {
            ...
            if( doc != null && validateRequest() )
            {
                ...
                doc.InsertParagraph("                   Sanction of the Supdt. of Post offices, Rourkela Division, Rourkela is hereby accorded for payment of Rs. " +
                    metroTextBox3.Text + "/- (" + words(Convert.ToDouble(metroTextBox3.Text), true) + ") only begin the expenditure incurred towards the cost of payment of telephone" +
                    " bill for the below mentioned offices for the month of "+ metroTextBox5.Text).Alignment = Alignment.both;
                ...
                t.Rows[0].Cells[1].Paragraphs.First().Append("Office Name").Bold();
                t.Rows[0].Cells[2].Paragraphs.First().Append("Telephone").Bold();
                ...
                doc.InsertList(doc.AddList("The DA (P), Cuttack-753004.", 0, ListItemType.Numbered, 2));
                doc.InsertList(doc.AddList("Office copy.", 0, ListItemType.Numbered, 3));
